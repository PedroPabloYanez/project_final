class ProjectsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @project.save
        ProjectMailer.project_create(current_user, project).deliver_later
        ProjectMailer.new_project(user, project).deliver_later
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:name, :description, :status, :initial_date, :finish_date, :team_id, :user_id)
    end
end
